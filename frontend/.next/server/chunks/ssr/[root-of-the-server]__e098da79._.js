...
"[project]/src/app/[slug]/login/LoginPage.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage({ slug }) {
    ...
    const handleLogin = async (e)=>{
        ...
        setSuccessMsg("");
        try {
            const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:3000")}/api/login/${slug}`, {
                method: "POST",
                headers: {
    ...
    const handleGoogleLogin = ()=>{
        window.location.href = `${"TURBOPACK compile-time value", "http://localhost:3000"}/auth/google?slug=${slug}`;
    };
    if (checkingAuth) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e098da79._.js.map