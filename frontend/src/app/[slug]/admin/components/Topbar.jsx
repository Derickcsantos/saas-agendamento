...
export default function Topbar({ org, slug }) {
  ...
  return (
    <header className=" shadow-sm px-6 py-3 flex justify-between items-center" style={{backgroundColor: palette?.strong_color || '#dfdfdf'}}>
      <h1 className="text-lg font-semibold " style={{color: palette?.text_light_color || '#ffffff'}}>
